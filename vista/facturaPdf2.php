...
$sentencia="SELECT * FROM cliente WHERE clienumerodoc = '$id_cliente'";
...
//CONSULTA
$sentencia="SELECT  prodid, prodmarca, prodprecio, cantidad, cantidad * prodprecio AS subtotal FROM factura LEFT JOIN producto ON id_producto = prodid";
$resultado=Conectarse()->query($sentencia) or die (mysqli_error(Conectarse()));
